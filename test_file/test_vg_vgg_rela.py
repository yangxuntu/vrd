...
from net.vtranse_vgg3 import VTranse
...
name = 'pred_res/vg_rela_res.txt'
for r in range(40,50):
	roidb_path = cfg.DIR + 'vtranse/input/vg_rela_roidb.npz'
	model_path = cfg.DIR + 'vtranse/pred_para/vg_vgg_rela/vg_vgg3' + format(int(r),'04') + '.ckpt'
	...
	text_file.write('{0}\n'.format('vg_vgg3' + format(int(r),'04') + '.ckpt'))
